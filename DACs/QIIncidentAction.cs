...
{
    [Serializable]
    [PXCacheName("QI Incident Action")]
    public class QIIncidentAction : IBqlTable
    {
        ...
        [PXParent(typeof(SelectFrom<QIIncident>.
                    Where<QIIncident.qIIncidentNbr.
                        IsEqual<QIIncidentAction.qIIncidentNbr.FromCurrent>>))]
        ...
        #region LineNbr
        [PXDBInt(IsKey = true)]
        [PXLineNbr(typeof(QIIncident.planLineCntr))]
        ...
        [PXDefault(typeof(Search<QIActionCode.descr, Where<QIActionCode.qIActionCodeID, Equal<Current<qIActionCodeID>>>>), PersistingCheck = PXPersistingCheck.Nothing)]
        ...
        [QIActionStatus.List]
        [PXDefault(QIActionStatus.NotStarted)]
        [PXUIField(DisplayName = "Action Status")]
        public virtual string ActionStatus { get; set; }
        public abstract class actionStatus : PX.Data.BQL.BqlString.Field<actionStatus> { }
        #endregion
